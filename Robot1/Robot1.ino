...
//debug MChLeg leftLeg(0, servoPin1); //left knee - hip (no knee yet)
Servo leftLeg; //replacement for Leg object
...
void loop(){
    ...
    switch (machinestate) {
        case 0:{
            ...
            //debug leftLeg.setLeg(0, 0); // set leg to 0°
            leftLeg.write(0);
